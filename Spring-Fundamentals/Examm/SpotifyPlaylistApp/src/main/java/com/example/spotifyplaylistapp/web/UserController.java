...
public class UserController {
    ...
    public String registerPost(@Valid UserRegisterBindingModel userRegisterBindingModel,
        ...
        if (bindingResult.hasErrors() || !userRegisterBindingModel.getPassword().equals(userRegisterBindingModel.getConfirmPassword())
                || this.userService.existsByUsernameOrEmail(userRegisterBindingModel.getUsername(), userRegisterBindingModel.getEmail())) {
    ...
    public String loginPost(@Valid UserLoginBindingModel userLoginBindingModel,
        ...
        if (!this.userService.existsByUsernameAndPassword(userLoginBindingModel.getUsername(), userLoginBindingModel.getPassword())) {
            redirectAttributes.addFlashAttribute("userLoginBindingModel", userLoginBindingModel);
